      ...
      <section className="relative overflow-hidden bg-paper">
        <div className="mx-auto grid min-h-[calc(100vh-5rem)] max-w-7xl items-start gap-10 px-4 py-14 sm:px-6 lg:grid-cols-[1fr_0.9fr] lg:px-8">
          <div>
            ...
            <h1 className="mt-5 text-balance text-6xl font-black leading-[1.02] text-ink sm:text-7xl lg:text-8xl">SUSTAIN-X</h1>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Button size="lg" asChild><Link href="/onboarding">Try Sustain-X</Link></Button>
