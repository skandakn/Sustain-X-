<div align="center">
  ...
  <img src="assets/hero-banner.svg" alt="Sustain-X - Technology that adapts to the way you learn" width="100%" />

  <br/><br/>

  <!-- Shields Badges Row 1: Frameworks & AI -->
  <a href="https://nextjs.org/"><img src="https://img.shields.io/badge/Next.js%2015-000000?style=for-the-badge&logo=nextdotjs&logoColor=white" alt="Next.js 15" /></a>
  ...
  <img src="https://img.shields.io/badge/Accessibility-WCAG%202.1%20AAA-10B981?style=flat-square&logo=w3c&logoColor=white" alt="WCAG 2.1 AAA" />
  <img src="https://img.shields.io/badge/Neurodiversity-ADHD%20%26%20Dyslexia%20Ready-06B6D4?style=flat-square&logo=visualstudiocode&logoColor=white" alt="Neurodiversity Ready" />
  <img src="https://img.shields.io/badge/PRs-Welcome-brightgreen.svg?style=flat-square" alt="PRs Welcome" />
  <img src="https://img.shields.io/badge/License-MIT-blue.svg?style=flat-square" alt="MIT License" />
  <img src="https://img.shields.io/github/stars/skandakn/Sustain-X?style=flat-square&color=yellow" alt="Stars" />
...
<div align="center">
  <img src="assets/sustain-x-hero-showcase.jpg" alt="Sustain-X 3D Product Showcase" width="100%" style="border-radius: 14px; box-shadow: 0 20px 40px rgba(0,0,0,0.6);" />
</div>
...
<div align="center">
  <img src="assets/features-grid.svg" alt="Sustain-X Core Features" width="100%" />
</div>
...
<div align="center">
  <img src="assets/demo-showcase.svg" alt="Sustain-X Split Learning View" width="100%" />
</div>
...
<div align="center">
  <img src="assets/architecture-diagram.svg" alt="Sustain-X Architecture Diagram" width="100%" />
</div>

```mermaid
flowchart LR
    subgraph Client [Client Presentation Layer]
        A[Next.js 15 App Router] --> B[React 19 & Framer Motion]
        B --> C[Accessibility Engine\nOpenDyslexic / Bionic / Ruler]
        B --> D[Multimodal Ingest\nMic STT / Vision OCR / PDF]
    end

    subgraph Service [Edge Orchestration Layer]
        E[lib/ai-service.ts] --> F[Next.js Route Handlers\n/api/adapt, /api/notes, /api/live]
        F --> G[Clerk Auth Middleware\nJWT Guard & Session Management]
    end
    ...
    subgraph Storage [Database & Persistence]
        L[Supabase PostgreSQL] --> M[Row Level Security Policies]
        M --> N[Student Profiles & Saved Notes]
        M --> O[Progress Analytics & Teacher Insights]
    end
...
<div align="center">
  ...
  **Created with 💚 by [Skanda K N](https://github.com/skandakn)**
  ...
  <a href="https://github.com/skandakn/Sustain-X-/stargazers"><img src="https://img.shields.io/badge/Star%20Repo-⭐-yellow?style=for-the-badge" alt="Star Sustain-X" /></a>
  <a href="https://github.com/skandakn/Sustain-X-/issues"><img src="https://img.shields.io/badge/Report%20Issue-🐛-red?style=for-the-badge" alt="Report Issue" /></a>
